...
import io.dshroid.core.CtlResult
...
class LinuxService : Service() {
    ...
    companion object {
        const val ACTION_START = "io.dshroid.action.START"
        const val ACTION_STOP = "io.dshroid.action.STOP"
        const val ACTION_RESTART = "io.dshroid.action.RESTART"
        const val ACTION_OPEN = "io.dshroid.action.OPEN"
        const val ACTION_SYNC = "io.dshroid.action.SYNC"

        private const val POLL_INTERVAL_MS = 5_000L
        private const val WAKE_LOCK_TAG = "dshroid:linux-status"

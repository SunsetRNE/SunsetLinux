...
object TransportSupport {
    ...
    /** 34 字节的 zstd 帧，解压后是 [PROBE_TEXT]。 */
    private const val PROBE_ZSTD_B64 = "KLUv/SQVqQAAZHNocm9pZC16c3RkLXByb2JlLXYxt5swcQ=="
    private const val PROBE_TEXT = "dshroid-zstd-probe-v1"
    ...
    private fun runProbe(): String? {
        val dir = File(System.getProperty("java.io.tmpdir") ?: ".", "dshroid-zstd-probe")
